...
<div class="amelia-booking">
    <div id="amelia-app-backend">
        <router-view></router-view>
    </div>
    <div class="amelia-export-ics">
        <a href="<?php echo AMELIA_ACTION_URL . 'export/ics'; ?>" class="button button-primary">
            <?php _e('Export Calendar (ICS)', 'wpamelia'); ?>
        </a>
    </div>
</div>
